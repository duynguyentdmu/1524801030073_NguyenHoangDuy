...
if($lastInsertId)
{
$_SESSION['msg']="Sách được liệt kê thành công!";
...
<head>
    ...
    <title>Online Library Management System | THÊM SÁCH</title>
...
<p class="help-block">Một số sách tiêu chuẩn quốc tế. Số ISBN Phải là duy nhất</p>
</div>
