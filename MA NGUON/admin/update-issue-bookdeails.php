...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">CHI TIẾT TRẢ SÁCH</h4>
...
<div class="form-group">
<label>Phạt tiền (bằng USD):</label>
<?php 
if($result->fine=="")
{?>
...
<button type="submit" name="return" id="submit" class="btn btn-info">TRẢ SÁCH </button>
