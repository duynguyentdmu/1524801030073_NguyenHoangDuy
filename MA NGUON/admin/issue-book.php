...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">CHO MƯỢN SÁCH MỚI</h4>
...
<label>Mã học sinh<span style="color:red;">*</span></label>
...
<div class="form-group">
<label>Số ISBN hoặc Tiêu đề sách<span style="color:red;">*</span></label>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">CHO MƯỢN</button>
