...
$query->execute();
$_SESSION['msg']="Thông tin sách được cập nhật thành công";
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">THÊM SÁCH</h4>
...
<div class="form-group">
<label> Tác giả<span style="color:red;">*</span></label>
...
<div class="form-group">
<label>Số ISBN<span style="color:red;">*</span></label>
<input class="form-control" type="text" name="isbn" value="<?php echo htmlentities($result->ISBNNumber);?>"  required="required" />
<p class="help-block">Thêm ISBN, Số ISBN là số sách tiêu chuẩn quốc tế. ISBN Phải là duy nhất</p>
</div>

 <div class="form-group">
 <label>Giá bán<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="price" value="<?php echo htmlentities($result->BookPrice);?>"   required="required" />
 </div>
 <?php }} ?>
<button type="submit" name="update" class="btn btn-info">CẬP NHẬT </button>
